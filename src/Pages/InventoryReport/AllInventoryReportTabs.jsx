...
import StockRportView from "./StockReport/StockRportView";
import StocklimitView from "../Invoice/Rework Entry/StockLimit/StocklimitView";

export const AllInventoryReportTabs = () => {
