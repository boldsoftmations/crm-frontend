...
import { BulkCustomerAssign } from "../CompanyDetails/BulkCustomerAssign";
import { UpdateAllCompanyDetails } from "../CompanyDetails/UpdateAllCompanyDetails";

export const BlackListedCustomerView = () => {
  ...
  const getAllCompanyDetails = async () => {
    try {
      ...
      const status =
        filterValue === "close_blacklisted" ? ["closed", "blacklisted"] : null;

      let response;
      if (status || searchValue) {
        response = await CustomerServices.getClosedOrBlacklistedCustomers({
          page: currentPage,
          assignToFilter: filterValue,
          searchValue: searchValue,
          status: status, // Sending status filter in the API request
        });
      } else {
        response = await CustomerServices.getClosedOrBlacklistedCustomers({
          page: currentPage,
